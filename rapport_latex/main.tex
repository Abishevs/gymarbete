...
Som det diskuterades tidigare är Riffle Shuffle den mest kända
kortblandingsmetoden. I denna studie anpassades \gls{gsr} modelen (för matematiken bakom
modellen se sektion \ref{sec:riffle_shuffle}). Den valdes för att utforska hur
väl den presterar i kortleksblandingar. Och om den skulle vara en lämligt
kandidat för den potentiella kortleksblandaren.

\boldsection{Potentiell fysikt design} 
...
\boldsection{SOC Pile Shuffle}: Inspiration att undersöka pile shuffle kom ifrån
\textcite{3DprintedLife2021},
där pile shuffle implementerades i en 3d printat kortleksblandare.  

\boldsection{Six Pile Shuffle}: 


\boldsection{Ten Pile Shuffle}: 
