...
% och användes bibliotek (Rust Crates) som Rand
% version 0.8 för PRNG \parencite{rand_crate}.
...
% \lstinputlisting[language=Rust, caption={Pile Shuffle skriven i Rust},label=selection-sort, label={lst:algo_1},firstline=30, lastline=45]{../simulation_rust/src/main.rs}
